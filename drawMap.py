...
def draw_window(throwing_bubble_rect, bubble_color, next_bubble_color, status, level):
    ...
    if result_text[0] != "":
        ...
        heigh = (HEIGHT - SETTINGS_SPACE - result.get_height())/2
        GAME_WINDOW.blit(result,((WIDTH - result.get_width())/2, heigh))
        GAME_WINDOW.blit(level_text,((WIDTH - level_text.get_width())/2, (heigh+ level_text.get_height()+20)))
